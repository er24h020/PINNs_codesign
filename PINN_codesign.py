...
loss_highdim_noise_500 = f"loss_noise_{now}.npy"
beta_highdim_noise_500 = f"beta_noise_{now}.npy"
np.save(loss_highdim_noise_500, loss_history)
np.save(beta_highdim_noise_500, beta_history)
